...
//         'from_id': pref.getString("uid").toString(),
...
class _MyChatPageState extends State<MyChatPage> {
  ...
  Future<void> view_message() async {
    final pref = await SharedPreferences.getInstance();
    name = "Trainer"; // kept simple display
                ...
                return Container(
                  ...
                  child: Align(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        color: isSender
                            ? Color(0xFFB6FF3B).withOpacity(0.15)
                            : Color(0xFF12181F),
